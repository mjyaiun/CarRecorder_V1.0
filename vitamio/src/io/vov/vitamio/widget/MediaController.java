...
public class MediaController extends FrameLayout {
  ...
  private void initHeader() {
    ...
    headerView.setPadding(10,15,10,15);
    headerView.setBackgroundColor(Color.parseColor("#ff303030"));

    ImageView back = new ImageView(mContext);
    back.setBackground(getResources().getDrawable(getResources().getIdentifier("back_arrow", "drawable", mContext.getPackageName()),null));
    ...
    headerView.addView(back, LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
    ...
    headerView.addView(mFileName,LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);

    header = new PopupWindow(mContext);

    header.setContentView(headerView);
    header.setWidth(LayoutParams.MATCH_PARENT);
    header.setHeight(LayoutParams.WRAP_CONTENT);

    header.setTouchInterceptor(new OnTouchListener() {
    ...
    header.setOutsideTouchable(true);
  }
	...
	public void setWindowLayoutType() {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
			try {
                ...
                setWindowLayoutType.invoke(header, WindowManager.LayoutParams.TYPE_APPLICATION_ATTACHED_DIALOG);
			} catch (Exception e) {
  ...
  public void setAnchorView(View view) {
    ...
    if (!mFromXml) {
      ...
      mRoot.setBackgroundColor(Color.parseColor("#ff303030"));
  ...
  public void show(int timeout) {
    ...
    if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
      ...
      if (mFromXml) {
        ...
        header.setAnimationStyle(mAnimStyle);
        setWindowLayoutType();
        mWindow.showAtLocation(mAnchor, Gravity.NO_GRAVITY, anchorRect.left, anchorRect.bottom);


        header.showAtLocation(mAnchor, Gravity.NO_GRAVITY, anchorRect.left, anchorRect.top);
